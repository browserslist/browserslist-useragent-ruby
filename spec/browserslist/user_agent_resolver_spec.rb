...
RSpec.describe Browserslist::Useragent::UserAgentResolver do
  describe '#call' do
    ...
    it 'resolves all browsers in iOS to safari with correct platform version' do
      ...
      ).to have_attributes(family: 'iOS', version: '10.3.0')
      ...
      ).to have_attributes(family: 'iOS', version: '8.3.0')
    end
    ...
    it 'resolves IE/Edge properly' do
      ...
      ).to have_attributes(family: 'Explorer', version: '11.0.0')
      ...
      ).to have_attributes(family: 'ExplorerMobile', version: '10.0.0')
      ...
      ).to have_attributes(family: 'Edge', version: '14.1.0')
    end
    ...
    it 'resolves chrome/android properly' do
      ...
      ).to have_attributes(family: 'Chrome', version: '41.0.228')
      ...
      ).to have_attributes(family: 'Android', version: '2.3.3')
    ...
    it 'resolves firefox properly' do
      ...
      ).to have_attributes(family: 'Firefox', version: '41.0.0')
      ...
      ).to have_attributes(family: 'Firefox', version: '44.0.0')
    end
  end
end
